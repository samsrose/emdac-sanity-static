...
import { LegislativeRecord } from "../lib/types"

interface LegislativeItemProps {
    data: LegislativeRecord[]
}

export default function LegislativeItem({ data }: LegislativeItemProps) {
    return (
        <>
