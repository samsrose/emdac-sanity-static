...
export default function MoreStories({ posts, buttonLink }: MoreStoriesProps) {
  return (
    <section>
      <div className="bg-gradient-to-b from-gray-800/50 to-gray-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 lg:gap-x-8 gap-y-12 md:gap-y-16 mb-12">
            {posts.map((post) => (
              <PostPlug
                key={post.slug}
                title={post.title}
