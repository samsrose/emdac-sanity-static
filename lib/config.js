export const sanityConfig = {
  ...
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || 'gx8gnj1q',
  useCdn:
...
//   projectId: process.env._SANITY_PROJECT_ID2,
//   dataset: process.env._SANITY_DATASET2,
//   apiVersion: process.env.*NEXT_PUBLIC_SANITY_API_VERSION2,
// });
